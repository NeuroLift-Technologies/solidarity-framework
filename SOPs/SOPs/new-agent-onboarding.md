...
- Ability to read files from `NeuroLift-Technologies/solidarity-framework` (this repo)
...
Read `NLT-DEV-OTOI.md` in this repository (`NeuroLift-Technologies/solidarity-framework`):
...
*SOP-NLT-001 v1.0.0 | NeuroLift Technologies | ORG-DEV-OTOI-1.0.3*
