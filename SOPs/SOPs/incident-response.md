...
repository (this template already exists inside `solidarity-framework`). This catches secrets before
they are ever committed:

```bash
# Run from the root of the solidarity-framework repository
